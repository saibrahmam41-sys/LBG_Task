...
final class POSAppTests: XCTestCase {
    ...
    func test_jailbreakDetector_mockedTrue() {
           let detector = MockJailbreakDetector(jailbroken: true)
           XCTAssertTrue(detector.isJailbroken())
       }

       func test_jailbreakDetector_mockedFalse() {
           let detector = MockJailbreakDetector(jailbroken: false)
